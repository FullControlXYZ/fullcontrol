from lab.fullcontrol.multiaxis.gcode.XYZBC.point import Point as FiveAxisPoint
from fullcontrol.combinations.gcode_and_visualize.classes import Point as ThreeAxisPoint
from lab.fullcontrol.multiaxis.gcode.XYZBC.printer import Printer as FiveAxisPrinter
from fullcontrol.combinations.gcode_and_visualize.classes import Printer as ThreeAxisPrinter
from lab.fullcontrol.multiaxis.gcode.XYZBC.controls import GcodeControls as FiveAxisGcodeControls
...
class Printer(FiveAxisPrinter, ThreeAxisPrinter):
    'set print_speed and travel_speed of the 3D printer and the BC intercept point. see documentation for info about other attributes'
    pass
