...
def reflectXY_mc(p: Point, m_reflect: float, c_reflect: float) -> Point:
    ...
    c_reflect_normal = p.y - (m_reflect_normal * p.x)  # intercept of the normal of the reflection line
    p_foot = Point(x=(c_reflect_normal - c_reflect) / (m_reflect - m_reflect_normal),
