...
def set_up(user_overrides: dict):
    ...
    import fullcontrol.gcode.printer_library.singletool.ender_3
    initialization_data = fullcontrol.gcode.printer_library.singletool.ender_3.set_up(user_overrides)
